...
{
    public class WireCartDataContextSeeds
    {
        public static async Task SeedAsync(WireCartDataContext dbContext, ILoggerFactory loggerFactory, int? retry = 0)
        {
            ...
            try
            {
                ...
                {
                    dbContext.SubCategories.AddRange(GetPreconfiguredSubCategories());
                    await dbContext.SaveChangesAsync();
                }
            ...
            catch (Exception exception)
            {
                if (retryForAvailability < 10)
                {
                    ...
                    var log = loggerFactory.CreateLogger<WireCartDataContextSeeds>();
